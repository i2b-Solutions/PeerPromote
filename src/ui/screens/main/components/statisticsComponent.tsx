        ...
        <StatisticsContainer container spacing={3}>
            ...
            {statisticsData.map((data) => (
                <Grid item xs={6} md={3} key={data.name}>
                    <Box>
                        {/* Statistic Value */}
                        <Typography variant="h4" fontWeight={PoppinsFontWeights.BOLD} color={Colors.main.blue} sx={{ mb: 1 }}>
                            {`${data.value}K+`}
                        </Typography>
                        {/* Statistic Name */}
                        <Typography variant="body1" fontWeight={PoppinsFontWeights.MEDIUM} color={Colors.main.mediumGrey}>
                            {t(data.name)}
                        </Typography>
                    </Box>
                </Grid>
