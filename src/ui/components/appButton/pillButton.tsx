...
const getStyle = (palette: ButtonPalette, variation: ButtonVariation, disabled: boolean) => {
...
const AppPillButton = styled(Button)(({ palette = 'primary', variation = 'fill', disabled = false }: AppPillButtonProps) => ({
